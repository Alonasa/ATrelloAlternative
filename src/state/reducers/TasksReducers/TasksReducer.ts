  ...
  switch (action.type) {
    ...
    case "REMOVE-TASK": {
      return {
        ...state,
        [action.payload.tlId]: [
          ...state[action.payload.tlId].filter(
...
export const RemoveTaskTC =
  (tlId: string, taskId: string) => (dispatch: Dispatch) => {
...
export const AddTaskTC =
  (tlId: string, title: string) => (dispatch: Dispatch<ActionsType>) => {
...
export const UpdateTaskTC =
  (tlId: string, id: string, domainModel: UpdateDomainTaskModelType) =>
