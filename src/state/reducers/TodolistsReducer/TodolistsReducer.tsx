...
export type SetTodolistEntityStatusACType = ReturnType<
  typeof SetTodolistEntityStatusAC
>;
...
export const ChangeTodolistTitleTC =
  (tlId: string, newTitle: string) => (dispatch: Dispatch) => {
    dispatch(setAppStatusAC("loading"));
    TodolistsAPI.updateTodolist(tlId, newTitle).then(() => {
