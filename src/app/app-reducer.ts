...
type ActionsType = SetAppStatusACType | SetAppErrorACType | SetInitializedACType
...
export const setInitializedAC = (isInitialized: boolean)=> {return {type: 'APP/SET-INITIALIZED', isInitialized} as const}